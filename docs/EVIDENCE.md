...
| 11 | Bảng C Gazebo — LLM tool-calls | 3/3 tool-plan PASS · 0/3 Nav² PASS | ollama qwen2.5:7b · GT-registry · teleport-pick (P2.6 trước) | commit `bc38da6`, `eval/results/report_v2.md §Bảng C` | `source colcon_ws/install/setup.bash && LLM_PROVIDER=ollama python3 eval/run_eval_gazebo.py` |
